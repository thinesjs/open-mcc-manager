...
const PINNED_DECLARATIONS: readonly string[] = [
	...
	":root --duration-press: 150ms",
	":root --duration-surface: 270ms",
	":root --ease-emphasis: cubic-bezier(0.26, 1, 0.5, 1)",
	":root --ease-settle: cubic-bezier(0.65, 0, 0.35, 1)",
	...
	":root --primary: var(--color-zinc-900)",
	...
	":root --update-foreground: var(--color-zinc-600)",
	":root --update-surface: color-mix(in srgb, var(--update) 12%, transparent)",
	":root --update: var(--color-zinc-400)",
	...
	":root > @variant dark --primary-foreground: var(--color-neutral-900)",
	":root > @variant dark --primary: var(--color-neutral-100)",
	...
	":root > @variant dark --update-foreground: var(--color-neutral-400)",
