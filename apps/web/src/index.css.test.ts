...
const PINNED_DECLARATIONS: readonly string[] = [
	...
	":root --ring: oklch(0.488 0.217 264)",
	...
	":root --terminal-scrollbar: rgb(0 0 0 / 15%)",
	...
	":root > @variant dark --destructive-foreground: var(--error-foreground)",
	":root > @variant dark --destructive: var(--error)",
	...
	":root > @variant dark --primary-foreground: var(--color-white)",
	":root > @variant dark --primary: oklch(0.588 0.217 264)",
	":root > @variant dark --ring: oklch(0.588 0.217 264)",
	":root > @variant dark --secondary-foreground: var(--color-neutral-100)",
	":root > @variant dark --secondary: --alpha(var(--color-white) / 4%)",
	":root > @variant dark --sidebar-border: var(--border)",
	":root > @variant dark --sidebar-foreground: var(--foreground)",
	":root > @variant dark --sidebar-muted-foreground: var(--muted-foreground)",
	":root > @variant dark --sidebar: var(--card)",
	":root > @variant dark --success-foreground: var(--color-emerald-400)",
	":root > @variant dark --success: var(--color-emerald-500)",
	":root > @variant dark --terminal-background: var(--background)",
	":root > @variant dark --terminal-cursor: rgb(180 203 255)",
	":root > @variant dark --terminal-foreground: var(--foreground)",
	":root > @variant dark --terminal-scrollbar: rgb(255 255 255 / 10%)",
	":root > @variant dark --terminal-selection-background: rgb(180 203 255 / 25%)",
	":root > @variant dark --update-foreground: var(--primary)",
	":root > @variant dark --update-surface: color-mix(in srgb, var(--update) 18%, transparent)",
	":root > @variant dark --update: var(--primary)",
	...
	":root > @variant dark --warning: var(--color-amber-500)",
	'@theme --font-mono: ui-monospace, "SF Mono", "SFMono-Regular", Menlo, Consolas, monospace',
